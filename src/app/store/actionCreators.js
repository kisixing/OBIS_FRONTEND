...
export const isTwinsAction = (bool) => ({
  type: IS_TWINS,
  bool
})

export const showDiagSearchAction = (bool) => ({
  type: SHOW_DIAG_SEARCH,
  bool
})
export const setDiagAction = (param) => ({
  type: SET_DIAGNOSIS,
  param
})
export const setDiagTempAction = (list) => ({
  type: GET_DIAG_TEMP,
  list
})

export const showPreeclampsiaAction = (bool) => ({
  type: SHOW_PREECLAMPSIA,
  bool
})
