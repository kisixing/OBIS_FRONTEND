            ...
            rows:[
              ...
              },
              {
                columns:[
                  ...
                  {span:1},
                  {name:'ckjcbtn1',type:'button',  shape:"circle", icon:"minus", span:1, size:'small', filter:entity=>entity.ckjc.length !==1, onClick:(e,text,resolve)=>this.handleChange(e, resolve, index)},
