    ...
    return {
      ...
      rows: [
        ...
        {columns:[
          {span:4},
          {rows:[
            {name:'gjtp[遗传病（男方）]', icon:'environment', type:'checkinput',options:baseData.ychOptions},
            {name:'xzp[遗传病（女方）]', icon:'environment-o', type:'checkinput', valid: 'required',options:baseData.ychOptions}
          ]}
        ]}
      ]
    };
